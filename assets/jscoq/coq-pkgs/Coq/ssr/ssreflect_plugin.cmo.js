...
L=b(aE[16],K,I),q=f(r[1][14],c,J,L),s=a(o[8],c),j=a(o[2],c),M=a(o[7],c),t=a(k[B][1],M);try{var
F=ab(r[1][16],xM,s,j,t,q,H,1),G=F[1],ag=F[2],ah=G[2],ai=G[1],x=ai,w=ah,v=ag}catch(a){a=P(a);if(a!==r[1][9])throw a;var
u=f(r[1][12],xI,s,q),x=u[1],w=u[2],v=t}var
y=b(h[88],w,c),d=a(k[8],x),N=a(k[8],v);if(b(aN[30],j,d)){var
O=a(e[3],xJ),Q=a(e[13],0),R=a(e[3],xK),S=a(e[13],0),T=a(k[B][1],d),U=a(r[1][31],T),V=a(e[13],0),W=a(e[3],xL),X=b(e[12],W,V),Y=b(e[12],X,U),Z=b(e[12],Y,S),_=b(e[12],Z,R),$=b(e[12],_,Q),aa=b(e[12],$,O);return a(h[15],aa)}var
g=b(k[3],j,d);if(5===g[0])if(2===g[2])var
E=g[1],D=y,C=g[3],l=1;else
var
l=0;else
var
l=0;if(!l)var
A=b(h[92],y,d),E=d,D=A[1],C=A[2];var
ac=a(k[20],[0,[0,n],E,C,N]),ad=b(h[dg],0,n),ae=a(h[cd],ac),af=a(i[70][8],ae);return f(z[5],af,ad,D)}var
